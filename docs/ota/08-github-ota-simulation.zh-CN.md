> English version: [08-github-ota-simulation.md](./08-github-ota-simulation.md)
...
| 7 | 安全增强（生产前） | Secure Boot v2 / Flash Encryption 需单独计划（eFuse 不可逆，需用户确认，见项目 human-gate 政策） |
